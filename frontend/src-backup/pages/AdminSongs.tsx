    ...
    return (
        <div className="admin-container animate-enter">
            ...
            {loading ? (
                ...
                <div className="admin-songs-list glass-panel">
                    <table className="admin-table">
                        ...
                        <tbody>
                            {songs.length === 0 ? (
                                <tr><td colSpan={6} style={{ textAlign: 'center', padding: '40px', color: 'rgba(255,255,255,0.4)' }}>No songs uploaded yet.</td></tr>
                            ) : songs.map(song => (
                                <tr key={song.id}>
                                    <td>
                                        {song.albumArtPath ? (
                                            <img
                                                src={song.albumArtPath.startsWith('http') ? song.albumArtPath : `${API_URL}${song.albumArtPath}`}
                                                alt=""
