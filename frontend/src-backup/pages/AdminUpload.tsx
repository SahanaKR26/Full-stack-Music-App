...
const AdminUpload = () => {
    ...
    const handleUpload = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Form reset
                setTitle(''); setArtist(''); setGenre('Electronic'); setReleaseDate(''); setLyrics('');
                setAudioFile(null); setAlbumArt(null);
    ...
    return (
        <div className="p-8 max-w-[1200px] mx-auto w-full animate-enter">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    {message && (
                        <div className={`p-4 rounded-xl border ${message.type === 'error' ? 'bg-red-500/10 border-red-500/20 text-red-500' : 'bg-emerald-500/10 border-emerald-500/20 text-emerald-500'}`}>
                            {message.text}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleUpload} className="space-y-8">
                        ...
                        <div className="flex flex-col gap-6">
                            <div
                                className="flex flex-col items-center gap-6 rounded-xl border-2 border-dashed border-slate-300 dark:border-primary/30 bg-white/50 dark:bg-primary/5 px-6 py-14 hover:border-primary transition-colors cursor-pointer group"
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 border border-slate-200 dark:border-primary/20 rounded-lg text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-primary/10 transition-colors"
                                >
                        ...
                        <div className="bg-white/80 dark:bg-primary/5 rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-primary/10 shadow-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <label className="flex flex-col gap-2 relative">
                                    ...
                                    <input
                                        className="form-input rounded-xl border border-slate-200 dark:border-primary/20 bg-slate-50 dark:bg-background-dark/50 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent h-12 px-4 transition-all"
                                ...
                                <label className="flex flex-col gap-2">
                                    ...
                                    <select
                                        className="form-select rounded-xl border border-slate-200 dark:border-primary/20 bg-slate-50 dark:bg-background-dark/50 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent h-12 px-4 transition-all"
                                        value={genre}
                                ...
                                <label className="flex flex-col gap-2 md:col-span-2">
                                    ...
                                    <textarea
                                        className="form-textarea rounded-xl border border-slate-200 dark:border-primary/20 bg-slate-50 dark:bg-background-dark/50 text-slate-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent min-h-[120px] p-4 transition-all"
                            ...
                            <div className="mt-8 flex justify-end gap-4">
                                ...
                                <button
                                    ...
                                    className={`px-8 py-3 rounded-xl bg-primary text-white font-bold transition-all shadow-lg shadow-primary/20 flex items-center gap-2 ${isUploading ? 'opacity-70 cursor-not-allowed' : 'hover:brightness-110 hover:scale-105 active:scale-95'}`}
                                >
                                    {isUploading ? (
                    ...
                    <div className="bg-white/80 dark:bg-primary/5 rounded-2xl border border-slate-200 dark:border-primary/10 overflow-hidden shadow-xl">
                        ...
                        <div className="divide-y divide-slate-100 dark:divide-primary/10">
                            {[
                                ...
                                <div key={idx} className="p-4 flex items-center gap-4 hover:bg-slate-50 dark:hover:bg-primary/5 transition-colors group cursor-pointer">
