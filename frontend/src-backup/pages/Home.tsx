...
const Home = () => {
    ...
    return (
        <div className="p-8 pt-4 space-y-10 animate-enter">
            {/* Hero Section */}
            <section className="relative h-64 rounded-xl overflow-hidden group">
                ...
                <div
                    ...
                    style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDuQ_S_ilRcEj_xOAoYCcBxjt6Co7zAhqeWH3WeVlhj9FSv0_DRh4sMIQ48uQAnqMuNOtaTSw9XWx2Vso65vhUAhKOzVC5ntkbohrFv9hcMBx1pDERxtGpB7-xwxT9q-KNhiguAZgfcOwSBm4Cjn_-4Ebhzr-f0F2SxqCcSp7z2jCUXBc8zvxVB3aZXVDmqfsuqzSFrtyxNEV8-dL7xVGPgWTOmPY6o1e27LoxJ44OT-SpjKumX7Be9fDXR7auDLSx0naYmj_uCz3M")' }}
                ></div>
                <div className="relative z-20 h-full flex flex-col justify-center p-8 max-w-lg">
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            className="bg-primary hover:bg-primary/90 text-white font-bold px-8 py-3 rounded-xl transition-all flex items-center gap-2"
                            onClick={() => heroSong && playSong(heroSong, songs)}
                        >
            ...
            <section>
                ...
                <div className="grid grid-cols-6 gap-6">
                    {[
                        ...
                        { name: "This Kid", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuADjOvUEkBY5uIlhRJeVCkReUPpecMNcI72bZZNwQmBizy2Mw1meOIjymC8w2h1BR7k6S-iMPezCwAU1Yq8jr9DkuhpVzLCcT8chJUtzagzCbrUEG7vH0THxNZjKSdU1gnNlxv0A1Og6aGXkQx78GsTn5nRcEoCv8XVr6sLhYueOftxQEVj94x8Uq6HJp97ZTGBC7kZnS2OQ5lsEia8ptlmqKKVxZ9Y2hUXv3fTsAbrPGWZm6so1K5d9axue-qloGUGUPBzGZs5or0" },
                        { name: "Kanye", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAUl1uZXs1IlUDPVbc14G9mq-Ea0AEvxrof0LLqAiuMePQOwNcIElkK1mGcNUJG8VEsyVqc25GBuSi5MYKcCMmtgfmjLnzb1oOQom7aLuDJ44gzldZRp5gKQzywE4BLvcsafTWh5EamtTl-MNzJetzPG7EvSTnM_VIT9eWXwYAMswNdrbIBeXzCOjgrjCElFXaWOAhc6AXx3dJPmmftSsApNp2PJPqJ0UfRtJ_ZJq9US4GwpUOm4nszassqW0kr_6OAzWOdwakD6Kk" },
                        ...
                        { name: "Starboy", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBiJCQ0FpJIhqcCzAVU-XFH_1z0tMwIjSh8fgeLuWX3SnPOKjzP9cZGgRSgCUDEIoBveB0OWWSTE0jqvsY8LrPjf7hqH61y3_EoxgpVaYV6_hPBCwh0OFk9i_VDYbLklaNCHYC0PQ9w_BRMJbBKz8p_Vde9sGFJUSqChHbd-Olckqq92Q2RZckOWwJeRMXcpsqms_pUzTO13tQm6XRQR9Su-BJLe6KQgvDk1a_LKxZeYsxxg9Jia5n4iBSsLFvgWhB3ceEtS57b0oQ" }
                    ].map((artist, idx) => (
                        <div key={idx} className="flex flex-col items-center gap-3">
                            <div
                                className="size-32 rounded-full bg-cover bg-center ring-4 ring-transparent hover:ring-primary/40 transition-all cursor-pointer shadow-lg"
            ...
            <section className="pb-8">
                ...
                {loading ? (
                    ...
                    <div className="bg-card-dark/50 rounded-xl border border-primary/5 overflow-hidden">
                                ...
                                {topCharts.map((song, idx) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-sm font-semibold text-slate-100 flex items-center gap-3">
                                            {song.albumArtPath ? (
                                                <img src={song.albumArtPath.startsWith('http') ? song.albumArtPath : `${API_URL}${song.albumArtPath}`} alt="art" className="size-10 rounded-md object-cover" />
                                            ) : (
                                                <div className="size-10 rounded-md bg-white/10 flex items-center justify-center">🎵</div>
                                            )}
                                            {song.title}
                                        </td>
                    ...
                    <div className="text-center text-slate-500 py-8 border border-primary/5 rounded-xl border-dashed">
