...
const Header = () => {
    const { username, subscriptionPlan, logout } = useAuth();
    ...
    return (<header className="h-16 flex items-center justify-between px-8 bg-background-dark/80 backdrop-blur-md z-10 shrink-0">
        <div className="w-96">
            <div className="relative group">
                ...
                <input className="w-full bg-card-dark border-none rounded-xl pl-10 pr-4 py-2 text-sm text-slate-100 focus:ring-1 focus:ring-primary focus:outline-none placeholder:text-slate-600 transition-all" placeholder="Search for songs, artists, or albums" type="text" />
            </div>
        </div>
