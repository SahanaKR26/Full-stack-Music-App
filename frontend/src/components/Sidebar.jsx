...
import { Home, Search, Radio, Disc, Mic2, History, Heart, Folder, PlusCircle, Plus, Music } from 'lucide-react';
import './Sidebar.css';
const Sidebar = () => {
    return (<aside className="w-64 bg-background-dark border-r border-primary/10 flex flex-col h-full overflow-y-auto custom-scrollbar shrink-0">
