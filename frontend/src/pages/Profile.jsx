...
const Profile = () => {
    ...
    const planColors = { Free: '#95a5a6', Premium: '#f1c40f', Pro: '#9b59b6' };
    const plan = subscriptionPlan || 'Free';
    return (<div className="profile-container animate-enter">
                ...
                <div className="profile-card glass-panel">
                    <div className="avatar-section">
                        <div className="profile-avatar-wrap">
                            {avatarUrl ? (<img src={avatarUrl.startsWith('http') ? avatarUrl : `${API_URL}${avatarUrl}`} alt="avatar" className="profile-avatar-img"/>) : (<div className="profile-avatar-placeholder">
                        ...
                        <h2>{username}</h2>
                        <span className="profile-plan-badge" style={{
